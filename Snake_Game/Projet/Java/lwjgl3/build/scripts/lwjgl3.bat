...
set CLASSPATH=%APP_HOME%\lib\SnakeGame-1.0.0.jar


@rem Execute lwjgl3
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %LWJGL3_OPTS%  -classpath "%CLASSPATH%" com.nous.snake.lwjgl3.Lwjgl3Launcher %*
